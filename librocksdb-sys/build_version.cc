...
static const std::string rocksdb_build_git_sha = "3258b5c3e2488464de0827343c8c27bc6499765e";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:v7.10.2";
#define HAS_GIT_CHANGES 0
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2023-03-22 09:30:39";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2023-03-22 09:20:39";
#endif
